...
public class JSONUtil{
	...
	JSONStringObject getJSONObject(Object value, boolean useClassConvert) throws JSONException{
        ...
        if (value instanceof Timestamp){
        	String str = DateHelper.getFormattedDateUtil((Timestamp)value, "yyyy-MM-dd HH:mm:ss");
            return new JSONStringObject(JSONObject.quote(str));
        }
        if (value instanceof Date){
        	String str = DateHelper.getFormattedDateUtil((Date)value, "yyyy-MM-dd HH:mm:ss");
            return new JSONStringObject(JSONObject.quote(str));
        }
